...
export default function SafeMode() {
  return (
    <View style={styles.container}>
      <Text style={styles.title}>This page is empty for now</Text>
    </View>
  );
}
...
//         const ws = new WebSocket('ws://30a2-2409-40c2-600b-49b2-b46d-51d8-11c9-b222.ngrok-free.app/ws/safemode-analysis');
